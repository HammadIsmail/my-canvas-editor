      ...
      <div className="p-6 border-b border-gray-100">
        ...
        {searchQuery && (
          <div className="mt-3 text-sm text-gray-600">
            ...
            {filteredPlatforms.length !== 1 ? "s" : ""} matching "{searchQuery}"
          </div>
        )}
      </div>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    >
                      <div
                        className={`w-12 h-12 rounded-lg ${platform.color} flex items-center justify-center transition-all duration-300 group-hover:scale-110`}
                      >
